...
const routes = [
    {
        ...
        children: [
            ...
            // },
            {
                ...
                loadChildren: () => Promise.all(/*! import() | pages-app-slides-slides-module */[__webpack_require__.e("default~home-home-module~pages-app-slides-slides-module~pages-login-login-module~pages-signup-signup-module"), __webpack_require__.e("pages-app-slides-slides-module")]).then(__webpack_require__.bind(null, /*! ../pages/app-slides/slides.module */ "./src/app/pages/app-slides/slides.module.ts")).then((e) => e.SlidesModule)
            }, {
                path: 'login',
                canActivate: [_shared_components_authentication_auth_guards_service__WEBPACK_IMPORTED_MODULE_4__["PreLogin"]],
                loadChildren: () => Promise.all(/*! import() | pages-login-login-module */[__webpack_require__.e("default~pages-about-us-about-us-module~pages-apply-coupon-apply-coupon-module~pages-bookings-booking~83a2ce79"), __webpack_require__.e("default~home-home-module~pages-app-slides-slides-module~pages-login-login-module~pages-signup-signup-module"), __webpack_require__.e("pages-login-login-module")]).then(__webpack_require__.bind(null, /*! ../pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then((e) => e.LoginPageModule)
            }, {
                path: 'sign-up',
