    ...
    var ServicesPage = /*#__PURE__*/function () {
      ...
      _createClass(ServicesPage, [{
        ...
        value: function onBookAppointment() {
          var storedServices = this.storageService.getStorageValue(_assets_constants_app_constants__WEBPACK_IMPORTED_MODULE_6__["appConstants"].SELECTED_SERVICES);
  ...
  function srcAppSharedComponentsServicesListServicesListPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ServicesListPage = /*#__PURE__*/function () {
      ...
      _createClass(ServicesListPage, [{
            ...
            if (changes.hasOwnProperty(propName)) {
              switch (propName) {
                case 'refreshRate':
                  {
                    setTimeout(function () {
                      if (_this2.apiCalled === 0) {
                        _this2.apiCalled = _this2.apiCalled + 1;

                        _this2.getAllDataAtOnce();
                      }
                    }, 500);
                  }
              }
        ...
        key: "getAllDataAtOnce",
        value: function getAllDataAtOnce() {
          var _this3 = this;
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["forkJoin"])([serviceTypes$, subServices$, services$]).subscribe(function (results) {
            _this3.apiCalled = _this3.apiCalled + 1;
            _this3.mainServices = results[0];
            _this3.subServices = results[1];
            _this3.services = results[2];

            var selectedServices = _this3.storageService.getStorageValue(_assets_constants_app_constants__WEBPACK_IMPORTED_MODULE_6__["appConstants"].SELECTED_SERVICES);

            var selectedServiceIds = selectedServices && selectedServices.length ? selectedServices.map(function (v) {
              return v.id;
            }) : [];
            _this3.mainServices = _this3.mainServices.map(function (main) {
              main.subServices = _this3.subServices.filter(function (v) {
                return v.serviceType.id === main.id;
              }).map(function (sub) {
                sub.services = _this3.services.filter(function (ser) {
                  return ser.subService && ser.subService.id === sub.id;
              ...
              main.services = _this3.services.filter(function (ser) {
                return ser.serviceType.id === main.id;
              }).filter(function (v) {
                return !v.subService;
              }).map(function (service) {
                service.isChecked = !!selectedServiceIds.includes(service.id);
            ...
            _this3.amountPurchased = _this3.calculateTotalAmount();

            _this3.sharedService.updateServiceTotal.next(_this3.amountPurchased);
          });
        }
      }, {
        key: "calculateTotalAmount",
        value: function calculateTotalAmount() {
          return this.mainServices.reduce(function (acc, first) {
            var onlyServicePrice = first.services.reduce(function (acc2, second) {
              if (second.isChecked) {
            ...
            var subServiceServicesPrice = first.subServices.reduce(function (acc2, subServ) {
              if (subServ && subServ.services && subServ.services.length > 0) {
                subServ.services.filter(function (v) {
                  return v.isChecked;
        ...
        value: function onSelectServices(service) {
          ...
          this.selectedServices = this.mainServices.reduce(function (acc, first) {
            ...
            if (first.subServices && first.subServices.length > 0) {
              selectedServices = [];
              selectedServices = first.subServices.reduce(function (acc2, subServ) {
                if (subServ && subServ.services && subServ.services.length > 0) {
                  acc2 = acc2.concat(subServ.services.filter(function (v) {
                    return v.isChecked;
                  }));
                }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], ServicesListPage.prototype, "refreshRate", void 0);
