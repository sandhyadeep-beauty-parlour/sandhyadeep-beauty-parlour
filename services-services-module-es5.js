...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["services-services-module"], {
    ...
    var ServicesModalComponent = /*#__PURE__*/function () {
      ...
      _createClass(ServicesModalComponent, [{
        ...
        value: function getBrandsSuccess(res) {
          ...
          this.brandsList = this.brandsList.sort(function (a, b) {
        ...
        value: function getSkinTypesSuccess(res) {
          ...
          this.skinTypesList = this.skinTypesList.sort(function (a, b) {
            return a.name.toLowerCase() > b.name.toLowerCase() ? 1 : -1;
          });
        }
      }, {
        ...
        value: function getServicesData() {
          ...
          var allSubServices$ = this.adminService.getAllSubService();
          var allServiceTypes$ = this.adminService.getAllServiceTypes();
          Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["forkJoin"])([allServiceTypes$, allSubServices$]).subscribe(function (results) {
            _this6.getServicesDataSuccess(results[0], results[1]);

            setTimeout(function () {
              _this6.patchServiceData();
            }, 500);
          }, function (error) {
        ...
        key: "onChangeServiceType",
        value: function onChangeServiceType(event) {
          var selectValue = event.target.value;
          this.filteredSubServices = this.subServices.filter(function (v) {
            return v.serviceType.id === selectValue;
          });
        }
      }, {
        key: "getServicesDataSuccess",
        value: function getServicesDataSuccess(serviceTypes, subServices) {
  ...
  function srcAppPagesAdminPanelServicesServicesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ServicesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _services_routing_module__WEBPACK_IMPORTED_MODULE_5__["ServicesPageRoutingModule"], _components_services_modal_services_modal_module__WEBPACK_IMPORTED_MODULE_7__["ServicesModalModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatDividerModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatCheckboxModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatRippleModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatExpansionModule"]],
