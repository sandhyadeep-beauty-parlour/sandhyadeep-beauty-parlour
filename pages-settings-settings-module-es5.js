...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-settings-settings-module"], {
  ...
  function srcAppPagesSettingsSettingsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_components_storage_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var SettingsPage = /*#__PURE__*/function () {
      function SettingsPage(storageService, apiService, alertController, router, sharedService) {
                  ...
                  case 0:
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        role: 'confirm',
                        handler: function handler() {
                          _this.sharedService.removeAllUserDetails();

                          _this.onLogout();

                          _this.handlerMessage = 'Alert confirmed';
                        }
                      }]
                    });
