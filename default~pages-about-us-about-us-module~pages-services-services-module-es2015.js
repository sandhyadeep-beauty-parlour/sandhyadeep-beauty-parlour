...
let ServicesListPage = class ServicesListPage {
    ...
    getAllServicesSuccess(res) {
        ...
        this.mainServices = this.mainServices.map((serv) => {
            serv.services = this.services.filter(v => v.serviceTypeId === serv._id);
            serv.show = false;
            return serv;
        });
...
ServicesListPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_service_service__WEBPACK_IMPORTED_MODULE_4__["SharedServiceService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]])
], ServicesListPage);
