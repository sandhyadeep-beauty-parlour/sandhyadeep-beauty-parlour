      ...
      _createClass(AboutUsPage, [{
        ...
        value: function slideNext(object, slideView) {
          ...
          slideView.slideNext(500).then(function () {
            _this10.checkIfNavDisabled(object, slideView);
          });
