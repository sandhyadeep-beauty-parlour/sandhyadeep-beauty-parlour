...
let SignupPage = class SignupPage {
    constructor(adminService, alertController, location, sharedService, router, formBuilder) {
    ...
    onSignUp() {
        ...
        this.adminService.updateUser(data, userId).subscribe(res => this.updateUserSuccess(res), error => {
